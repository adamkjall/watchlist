...
export default function Modal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 bg-gray-900/75 flex justify-center md:px-16 md:py-12"
    ...
    >
      ...
      >
        <div
          className="overflow-y-scroll bg-cover bg-no-repeat bg-center text-white p-4 md:rounded-xl mb-16 h-full bg-gray-700"
          style={{
